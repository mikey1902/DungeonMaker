...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": [
        ...
        m_Ground_Previous = m_Ground.FindAction("Previous", throwIfNotFound: true);
        m_Ground_Next = m_Ground.FindAction("Next", throwIfNotFound: true);
    ...
    private readonly InputAction m_Ground_Previous;
    private readonly InputAction m_Ground_Next;
    ...
    public struct GroundActions
    {
        ...
        /// <summary>
        /// Provides access to the underlying input action "Ground/Previous".
        /// </summary>
        public InputAction @Previous => m_Wrapper.m_Ground_Previous;
        /// <summary>
        /// Provides access to the underlying input action "Ground/Next".
        /// </summary>
        public InputAction @Next => m_Wrapper.m_Ground_Next;
        /// <summary>
